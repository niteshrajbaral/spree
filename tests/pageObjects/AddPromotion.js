class AddPromotion{
    constructor(){
        ...
        this.startDateIconSelector = "//div[@id='starts_at_field']/div/div/span[@class='input-group-text']";
        this.startDateSelector = "(//div[@class='dayContainer'])[1]/span[1]";
        this.headerSelector = "//div[@class='col text-right p-0']"
        this.endDateIconSelector = "//div[@id='expires_at_field']/div/div/span[@class='input-group-text']";
    ...
    async addDetails(name, code, path, description, limit ) {
